...
export default function DocumentArtifact({
  ...
  return (
    <div className="flex flex-col h-full w-full min-w-0">
      {/* Toolbar */}
      <div className="relative flex items-center justify-between px-4 py-3 border-b border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 flex-shrink-0 min-w-0 overflow-x-hidden">
