...
export const MobileNavigation: FC<MobileNavigationProps> = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-surface-dark-base border-t border-gray-300 dark:border-gray-700 z-20">
      {/* Expandable List */}
      {isExpanded && (
        <div className="border-b border-gray-300 dark:border-gray-700 max-h-[60vh] overflow-y-auto">
