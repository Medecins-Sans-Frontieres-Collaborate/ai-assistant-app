    ...
    <>
      ...
      {isMenuOpen && (
        <>
          ...
          />
          <div className="fixed top-[65px] left-0 right-0 bg-white dark:bg-surface-dark-base border-b border-gray-300 dark:border-gray-700 z-40 max-h-[60vh] overflow-y-auto">
