...
export function TeamTemplatesTab({ onClose }: TeamTemplatesTabProps) {
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {t(
                'Package your prompts, tones, and custom agents into a shareable file that other team members can easily import',
              )}
            </p>
          </div>
          ...
          <div className="space-y-4 border-t border-gray-200 dark:border-gray-700 pt-6">
            ...
            <div className="grid gap-3">
              <div className="p-4 rounded-lg bg-gray-50 dark:bg-neutral-800/50 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {t(
                    'Share a template with all your team prompts and tones to get new members up to speed quickly',
                  )}
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-gray-50 dark:bg-neutral-800/50 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {t('Create templates for different projects')}
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-gray-50 dark:bg-neutral-800/50 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {t(
                    'Export your configurations as a backup or to migrate between devices',
                  )}
                </p>
              </div>
            </div>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                          <span>
                            {t('Imported')}{' '}
                            {new Date(template.importedAt).toLocaleDateString()}
                          </span>
