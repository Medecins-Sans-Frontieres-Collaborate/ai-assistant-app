      ...
      <h1 className="text-2xl font-light bg-gradient-to-r rtl:bg-gradient-to-l from-[#F73837] from-0% via-rose-500 via-15% to-rose-900 to-100% dark:from-[#F73837] dark:from-0% dark:via-[#FF8A89] dark:via-15% dark:to-gray-400 dark:to-100% bg-clip-text text-transparent">
        {isInteractive ? (
          <span
            ...
            className="cursor-pointer transition-all duration-200 hover:opacity-80 hover:underline underline-offset-4 decoration-rose-500/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-500/50 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-[#212121] rounded"
          >
            {greetingText}
          </span>
        ) : (
